...
| Method            |      Mean |     Error |            Op/s | Ratio | Allocated | Alloc Ratio |
|-------------------|----------:|----------:|----------------:|------:|----------:|------------:|
| Equal             | 3.7399 ns | 0.0608 ns |   267,386,795.5 |  1.00 |         - |          NA |
| NotEqualValue     | 2.5186 ns | 0.0177 ns |   397,053,442.9 |  0.67 |         - |          NA |
| NotEqualCurrency  | 0.5785 ns | 0.0131 ns | 1,728,591,727.6 |  0.15 |         - |          NA |
| EqualOrBigger     | 5.2088 ns | 0.0242 ns |   191,983,656.4 |  1.39 |         - |          NA |
| Bigger            | 5.2113 ns | 0.0152 ns |   191,891,199.1 |  1.39 |         - |          NA |
| fEqual            | 0.1306 ns | 0.0316 ns | 7,658,922,507.6 |  0.03 |         - |          NA |
| fNotEqualValue    | 0.3180 ns | 0.0352 ns | 3,144,997,057.1 |  0.09 |         - |          NA |
...
| Method        |       Mean |     Error |              Op/s |  Ratio | Allocated | Alloc Ratio |
|---------------|-----------:|----------:|------------------:|-------:|----------:|------------:|
| ToDecimal     |  0.8285 ns | 0.0280 ns |   1,206,974,878.7 |  1.001 |         - |          NA |
| ToDouble      |  2.2197 ns | 0.0325 ns |     450,512,657.3 |  2.681 |         - |          NA |
| ToIn32        | 32.8231 ns | 0.6112 ns |      30,466,314.6 | 39.645 |         - |          NA |
| ToInt64       | 31.8772 ns | 0.1458 ns |      31,370,393.4 | 38.503 |         - |          NA |
| ToFastMoney   | 21.3855 ns | 0.1052 ns |      46,760,745.7 | 25.830 |         - |          NA |
| fToDecimal    |  2.7617 ns | 0.0649 ns |     362,092,391.0 |  3.336 |         - |          NA |
| fToDouble     |  3.6894 ns | 0.0279 ns |     271,044,570.8 |  4.456 |         - |          NA |
| fToIn32       |  4.1463 ns | 0.1087 ns |     241,180,855.3 |  5.008 |         - |          NA |
| fToInt64      |  4.0145 ns | 0.0953 ns |     249,096,827.4 |  4.849 |         - |          NA |
