...
| Method               |       Mean |     Error |             Op/s | Ratio |   Gen0 | Allocated | Alloc Ratio |
|----------------------|-----------:|----------:|-----------------:|------:|-------:|----------:|------------:|
| Equal                |  4.3204 ns | 0.0192 ns |    231,458,641.8 | 0.159 |      - |         - |          NA |
| NotEqualValue        |  3.3225 ns | 0.0487 ns |    300,978,329.4 | 0.122 |      - |         - |          NA |
| NotEqualCurrency     |  1.6321 ns | 0.0160 ns |    612,723,077.7 | 0.060 |      - |         - |          NA |
| EqualOrBigger        |  5.3260 ns | 0.0404 ns |    187,759,470.1 | 0.196 |      - |         - |          NA |
| Bigger               |  5.5527 ns | 0.0548 ns |    180,094,129.0 | 0.205 |      - |         - |          NA |
| fEqual               |  0.0655 ns | 0.0111 ns | 15,266,320,938.6 | 0.002 |      - |         - |          NA |
| fNotEqualValue       |  0.2560 ns | 0.0162 ns |  3,905,584,129.1 | 0.009 |      - |         - |          NA |
| fNotEqualCurrency    |  0.2402 ns | 0.0342 ns |  4,164,056,036.7 | 0.009 |      - |         - |          NA |
| fEqualOrBigger       | 16.6360 ns | 0.3567 ns |     60,110,525.1 | 0.613 |      - |         - |          NA |
| fBigger              | 17.3762 ns | 0.3135 ns |     57,550,011.3 | 0.640 |      - |         - |          NA |
