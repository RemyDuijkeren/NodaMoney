...
|---------------|-----------:|----------:|----------:|-----------:|-----------------:|------:|--------:|----------:|------------:|
| ToDecimal     |  0.8106 ns | 0.0282 ns | 0.0250 ns |  0.8071 ns |  1,233,579,828.7 |  1.00 |    0.04 |         - |          NA |
| ToDouble      |  3.0877 ns | 0.0854 ns | 0.0757 ns |  3.0706 ns |    323,868,987.6 |  3.81 |    0.14 |         - |          NA |
| ToIn32        | 21.4829 ns | 0.1669 ns | 0.1480 ns | 21.4541 ns |     46,548,555.3 | 26.52 |    0.79 |         - |          NA |
| ToInt64       | 21.6675 ns | 0.1646 ns | 0.1540 ns | 21.6564 ns |     46,152,103.4 | 26.75 |    0.80 |         - |          NA |
| ToFastMoney   | 28.5747 ns | 0.2191 ns | 0.2049 ns | 28.4761 ns |     34,995,945.1 | 35.28 |    1.06 |         - |          NA |
| fToDecimal    |  2.9903 ns | 0.0302 ns | 0.0283 ns |  2.9785 ns |    334,419,038.9 |  3.69 |    0.11 |         - |          NA |
| fToDouble     | 16.2772 ns | 0.1407 ns | 0.1247 ns | 16.2668 ns |     61,435,606.9 | 20.10 |    0.60 |         - |          NA |
| fToIn32       |  6.8392 ns | 0.0683 ns | 0.0639 ns |  6.8419 ns |    146,215,233.8 |  8.44 |    0.26 |         - |          NA |
| fToInt64      |  6.5582 ns | 0.0461 ns | 0.0385 ns |  6.5597 ns |    152,480,377.9 |  8.10 |    0.24 |         - |          NA |
| fToMoney      |  7.1316 ns | 0.0342 ns | 0.0303 ns |  7.1279 ns |    140,221,054.1 |  8.81 |    0.26 |         - |          NA |
| fToSqlMoney   | 22.3411 ns | 0.1249 ns | 0.1168 ns | 22.3561 ns |     44,760,592.5 | 27.58 |    0.82 |         - |          NA |
| fToAOCurrency |  0.0325 ns | 0.0262 ns | 0.0499 ns |  0.0074 ns | 30,795,599,650.9 |  0.04 |    0.06 |         - |          NA |
