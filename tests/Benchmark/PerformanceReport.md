...
| Method                      |          Mean |     Error |    StdDev | Ratio | RatioSD |   Gen0 | Allocated | Alloc Ratio |
|-----------------------------|--------------:|----------:|----------:|------:|--------:|-------:|----------:|------------:|
| Add                         | **36.203 ns** | 0.7320 ns | 0.7189 ns |  1.00 |    0.03 |      - |         - |          NA |
| AddFastMoney                |     12.171 ns | 0.2258 ns | 0.2113 ns |  0.34 |    0.01 |      - |         - |          NA |
| Subtract                    | **36.230 ns** | 0.7429 ns | 0.7296 ns |  1.00 |    0.03 |      - |         - |          NA |
| SubtractFastMoney           |      6.199 ns | 0.1351 ns | 0.1264 ns |  0.17 |    0.00 |      - |         - |          NA |
| Multiple                    |     32.738 ns | 0.6269 ns | 0.6708 ns |  0.90 |    0.02 |      - |         - |          NA |
| MultipleFastMoneyDecimal    |     30.623 ns | 0.6156 ns | 0.5758 ns |  0.85 |    0.02 |      - |         - |          NA |
| MultipleFastWholeDecimal    |     15.231 ns | 0.3342 ns | 0.5491 ns |  0.42 |    0.02 |      - |         - |          NA |
| MultipleFastMoneyLong       |      2.171 ns | 0.0430 ns | 0.0381 ns |  0.06 |    0.00 |      - |         - |          NA |
| Divide                      |     87.427 ns | 1.4775 ns | 1.3821 ns |  2.42 |    0.06 |      - |         - |          NA |
| DivideFastMoneyDecimal      |     82.499 ns | 0.6700 ns | 0.5594 ns |  2.28 |    0.05 |      - |         - |          NA |
| DivideFastMoneyWholeDecimal |     13.493 ns | 0.2865 ns | 0.3066 ns |  0.37 |    0.01 |      - |         - |          NA |
| DivideFastMoneyLong         |      1.940 ns | 0.0590 ns | 0.0606 ns |  0.05 |    0.00 |      - |         - |          NA |
| CompareSameCurrency         |  **8.553 ns** | 0.1361 ns | 0.1207 ns |  0.24 |    0.01 |      - |         - |          NA |
| CompareDifferentCurrency    |      5.458 ns | 0.1357 ns | 0.1393 ns |  0.15 |    0.00 |      - |         - |          NA |
| CompareAmount               |      9.752 ns | 0.1651 ns | 0.1463 ns |  0.27 |    0.01 |      - |         - |          NA |
| Increment                   |     90.687 ns | 1.7592 ns | 1.6455 ns |  2.51 |    0.07 | 0.0038 |      32 B |          NA |
| Decrement                   |     90.750 ns | 0.6998 ns | 0.5844 ns |  2.51 |    0.05 | 0.0038 |      32 B |          NA |
