...
public class ValidJsonV1TestData : TheoryData<string, Money>
{
    public ValidJsonV1TestData()
    {
        ...
        Add("""{ "Currency": "EUR", "Amount": 234.25 }""", money); // PascalCase, Amount as number, Reversed memb"ers
        Add("""{ "Amount": "234.25", "Currency": "EUR" }""", money); // PascalCase, Amount as str"ing
        Add("""{ "Currency": "EUR", "Amount": "234.25" }""", money); // PascalCase, Amount as string, Reversed memb"ers
        Add("""{ "amount": 234.25, "currency": "EUR" }""", money); // camelCase, Amount as num"ber
        Add("""{ "currency": "EUR", "amount": 234.25 }""", money); // camelCase, Amount as number, Reversed memb"ers
        Add("""{ "amount": "234.25", "currency": "EUR" }""", money); // camelCase, Amount as str"ing
        Add("""{ "currency": "EUR", "amount": "234.25" }""", money); // camelCase, Amount as string, Reversed memb"ers
