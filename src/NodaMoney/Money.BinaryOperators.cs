namespace NodaMoney
{
    ...
    public partial struct Money
    {
        ...
        public static Money Add(Money money1, decimal money2) => new Money(decimal.Add(money1.Amount, money2), money1.Currency);
        ...
        public static Money Subtract(Money money1, decimal money2) => new Money(decimal.Subtract(money1.Amount, money2), money1.Currency);
