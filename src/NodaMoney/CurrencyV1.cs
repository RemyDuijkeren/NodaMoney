...
public readonly struct CurrencyV1 : IEquatable<CurrencyV1>, IXmlSerializable, ISerializable
{
    /// <summary>
    ...
    internal CurrencyV1(string code, string @namespace = "ISO-4217")
    {
        CurrencyV1 c = FromCode(code, @namespace);
    ...
    internal CurrencyV1(string code, short number, byte minorUnitAsPowerOfTen, string englishName, string symbol, byte @namespace = 0, DateTime? validTo = null, DateTime? validFrom = null)
        //: this()
    {
        if (string.IsNullOrWhiteSpace(code))
            throw new ArgumentException("Value cannot be null or whitespace.", nameof(code));
        if (minorUnitAsPowerOfTen != Z07Byte && minorUnitAsPowerOfTen != NotApplicableByte && (minorUnitAsPowerOfTen < 0 || minorUnitAsPowerOfTen > 28))
...
#pragma warning disable CA1801 // Parameter context of method.ctor is never used.
    private CurrencyV1(SerializationInfo info, StreamingContext context)
...
#pragma warning restore CA1801 // Parameter context of method.ctor is never used.
    ...
    public static CurrencyV1 CurrentCurrency
    {
        get
        {
            ...
            return currentRegion.Name == "IV" ? FromCode("XXX") : FromRegion(currentRegion);
#endif
        }
    }
    ...
    public static bool operator ==(CurrencyV1 left, CurrencyV1 right) => left.Equals(right);

    /// <summary>Implements the operator ==.</summary>
    /// <param name="left">The left Currency.</param>
    /// <param name="right">The right Currency.</param>
    /// <returns>The result of the operator.</returns>
    public static bool operator !=(CurrencyV1 left, CurrencyV1 right) => !(left == right);
    ...
    public static CurrencyV1 FromCode(string code)
    {
        return new CurrencyV1("XXX", 0, 0, "No Currency", GenericCurrencySign);
    ...
    public static CurrencyV1 FromCode(string code, string @namespace)
    {
        return new CurrencyV1("XXX", 0, 0, "No Currency", GenericCurrencySign);
    ...
    /// <exception cref="ArgumentException">The 'code' is an unknown ISO 4217 currency code.</exception>
    public static CurrencyV1 FromRegion(RegionInfo region)
    {
        if (region == null)
    ...
    /// </exception>
    public static CurrencyV1 FromCulture(CultureInfo culture)
    {
        if (culture == null)
    ...
    public static CurrencyV1 FromRegion(string name)
    {
    ...
    public static IEnumerable<CurrencyV1> GetAllCurrencies() => [];
    //public static IEnumerable<CurrencyV1> GetAllCurrencies() => CurrencyRegistry.GetAllCurrencies();
    ...
    public static bool Equals(CurrencyV1 left, CurrencyV1 right) => left.Equals(right);
    ...
    public override bool Equals(object obj) => obj is CurrencyV1 currency && Equals(currency);
    ...
    /// <returns>true if value is equal to this instance; otherwise, false.</returns>
    [SuppressMessage("Microsoft.Design", "CA1062:Validate arguments of public methods", MessageId = "0", Justification = "Calling override method")]
    public bool Equals(CurrencyV1 other)
    {
